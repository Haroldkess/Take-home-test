...
void main() async {
  ...
  await Hive.openBox('geofenceSettings'); // Open the box for geofence settings
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          ...
          dividerTheme:
              const DividerThemeData(color: Color(0xFFEAECF0), space: 0),
          textButtonTheme: TextButtonThemeData(
            style:
                TextButton.styleFrom(foregroundColor: const Color(0xFF005b96)),
          ),
